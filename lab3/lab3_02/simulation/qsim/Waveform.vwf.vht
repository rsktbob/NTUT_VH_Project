...
-- *****************************************************************************
-- Generated on "10/10/2022 20:30:57"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          lab3_02
-- 
...
ENTITY lab3_02_vhd_vec_tst IS
END lab3_02_vhd_vec_tst;
ARCHITECTURE lab3_02_arch OF lab3_02_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
BEGIN
	B0(7) <= '0';
WAIT;
END PROCESS t_prcs_B0_7;
-- B0[6]
t_prcs_B0_6: PROCESS
BEGIN
	B0(6) <= '0';
WAIT;
END PROCESS t_prcs_B0_6;
-- B0[5]
t_prcs_B0_5: PROCESS
BEGIN
	B0(5) <= '0';
WAIT;
END PROCESS t_prcs_B0_5;
-- B0[4]
t_prcs_B0_4: PROCESS
BEGIN
	B0(4) <= '0';
